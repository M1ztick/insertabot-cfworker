...
import { remember, listMemories, recall, forget, type Memory } from './memory';
...
export class ChatAgent extends AIChatAgent<Env, ChatAgentState> {
	...
	/**
	 * Compose the system prompt, including any saved memories for this
	...
	private buildSystemPrompt(): string {
		...
		return `${base}\n\nThe following notes are from your previous interactions in this conversation and should inform your response when relevant:\n${memoryBlock}`;
	}
